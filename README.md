...
- **Carte 3D par défaut** : MapLibre GL hébergé localement (`vendor/maplibre/`, chargé à la demande)
  ...
  s'ouvre en 2D sur toute la côte et passe en 3D dès que le zoom dépasse 12 (geste, ouverture d'une fiche, zoom sur une entité ; retour en 2D en dézoomant à la main) ; les deux cartes
